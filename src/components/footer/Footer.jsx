                ...
                <div className={location.pathname == "/main" ? s.menu_item_active : s.menu_item} onClick={()=> navigate("/main")}>
                    <div className={s.image}>
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12.7 19.2V17.25C12.7 14.7982 12.7 13.5736 11.9382 12.8118C11.1764 12.05 9.9518 12.05 7.5 12.05H6.72C6.2377 12.05 5.9959 12.05 5.7918 12.0656C4.55741 12.1627 3.39818 12.6971 2.52263 13.5726C1.64709 14.4482 1.1127 15.6074 1.0156 16.8418C1 17.0459 1 17.289 1 17.77C1 17.8909 1 17.952 1.0039 18.0014C1.02805 18.3102 1.16167 18.6003 1.38071 18.8193C1.59974 19.0383 1.88978 19.172 2.1986 19.1961C2.27566 19.2002 2.35285 19.2015 2.43 19.2H12.7ZM12.7 19.2H19.2" stroke-width="1.5" stroke-linecap="round"/>
                            <path d="M10.75 19.2C10.75 20.2344 10.3391 21.2263 9.60767 21.9577C8.87628 22.6891 7.8843 23.1 6.84995 23.1C5.81561 23.1 4.82363 22.6891 4.09224 21.9577C3.36084 21.2263 2.94995 20.2344 2.94995 19.2M14 4.90001H14.6864C16.2503 4.90001 17.0316 4.90001 17.6595 5.28871C18.2887 5.67611 18.6384 6.37551 19.3365 7.77431L23.1 15.3M21.9859 12.7L22.8712 12.0474C23.2131 11.7952 23.3847 11.6704 23.503 11.5053C23.584 11.3937 23.6467 11.27 23.6889 11.1387C23.75 10.945 23.75 10.7331 23.75 10.3093C23.75 9.50591 23.75 9.10551 23.5784 8.80521C23.4632 8.60378 23.2962 8.43681 23.0948 8.32161C22.7958 8.15001 22.3928 8.15001 21.5907 8.15001H19.85"  stroke-width="1.5" stroke-linecap="round"/>
                            <path d="M23.1 23.1C25.2539 23.1 27 21.3539 27 19.2C27 17.0461 25.2539 15.3 23.1 15.3C20.946 15.3 19.2 17.0461 19.2 19.2C19.2 21.3539 20.946 23.1 23.1 23.1Z"  stroke-width="1.5"/>
                        </svg>
                    </div>
                ...
                <div className={location.pathname == "/about" ? s.menu_item_active : s.menu_item} onClick={()=> navigate("/about")}>
                    <div className={s.image}>
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14 24C19.5228 24 24 19.5228 24 14C24 8.47715 19.5228 4 14 4C8.47715 4 4 8.47715 4 14C4 19.5228 8.47715 24 14 24Z" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
